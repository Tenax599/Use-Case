...
function populateStudentList(students) {
  ...
  if (students.length === 0) {
    ...
    students.forEach(function (student) {
      ...
      var studentRow = "\n                <tr>\n                    <td>".concat(student.job_number, "</td>\n                    <td>").concat(student.name, "</td>\n                    <td>").concat(student.gender, "</td>\n                    <td>").concat(student.birthdate, "</td>\n                    <td>").concat(student.major, "</td>\n                    <td>").concat(student.position, "</td>\n                    <td>").concat(student.tch_pwd, "</td>\n                    <td><img src=\"http://localhost:3000/image?imageUrl=").concat(student.avatarUrl, "\" alt=\"Avatar\"></td>\n                    <td>\n                    <button type=\"button\" name=\"edit_student\" data-student-id=\"").concat(student.job_number, "\" class=\"btn btn-success btn-sm editStudentBtn\">\u7F16\u8F91</button>\n                    <button type=\"submit\" name=\"delete_student\" value=\"<?=$student['id'];?>\" class=\"btn btn-danger btn-sm\">Delete</button>\n                    <button type=\"button\" name=\"reset_password\" data-student-id=\"").concat(student.job_number, "\" class=\"btn btn-secondary btn-sm resetStudentBtn\">\u91CD\u7F6E\u5BC6\u7801</button>\n                    </td>\n                </tr>\n            ");
