    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap(axios.get(url.teacher.fetch, {
            params: {
...
function populateStudentList(students) {
  ...
  if (students.length === 0) {
    ...
    students.forEach(function (student) {
      var studentRow = "\n          <tr>\n            <td>".concat(student.job_number, "</td>\n            <td>").concat(student.teacher_name, "</td>\n            <td>").concat(student.student_id, "</td>\n            <td>").concat(student.student_name, "</td>\n            <td>").concat(student.major, "</td>\n            <td>").concat(student.course_number, "</td>\n            <td>").concat(student.course_name, "</td>\n            <td>").concat(student.score, "</td>\n            <td>\n              <button type=\"button\" name=\"edit_student\" data-student-id=\"").concat(student.student_number, "\" class=\"btn btn-success btn-sm editStudentBtn\">\u7F16\u8F91</button>\n            </td>\n          </tr>\n        ");
