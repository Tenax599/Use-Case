        ...
        students.forEach((student) => {
            ...
            const studentRow = `
                <tr>
                    ...
                    <td>
                    <button type="button" name="edit_student" data-student-id="${student.student_id}" class="btn btn-success btn-sm editStudentBtn">编辑</button>
                    <button type="submit" name="delete_student" value="<?=$student['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                    <button type="button" name="reset_password" data-student-id="${student.student_id}" class="btn btn-secondary btn-sm resetStudentBtn">重置密码</button>
                    </td>
                </tr>
            `;
